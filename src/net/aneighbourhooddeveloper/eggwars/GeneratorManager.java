package net.aneighbourhooddeveloper.eggwars;
			...
			public void run() {
				...
				while(iterator.hasNext()) {
					...
					if(generator.getType().equalsIgnoreCase("diamond")) {
						...
						switch (generator.getLevel()) {
							case 1:
								if(gold1%timePassed == 1) {
									generator.addItem();
									ItemStack gold = generator.getItems().get(generator.getItems().size()-1);
									Bukkit.getWorld("world").dropItem(generator.getLocation().add(0.5,1.5,0.5), gold);
								}
								break;
							case 2:
								if(gold2%timePassed == 1) {
									generator.addItem();
									ItemStack gold = generator.getItems().get(generator.getItems().size()-1);
									Bukkit.getWorld("world").dropItem(generator.getLocation().add(0.5,1.5,0.5), gold);
								}
						...
						switch (generator.getLevel()) {
							case 1:
								if(iron1%timePassed == 1) {
									generator.addItem();
									ItemStack iron = generator.getItems().get(generator.getItems().size()-1);
									Bukkit.getWorld("world").dropItem(generator.getLocation().add(0.5,1.5,0.5), iron);
								}
								break;
							case 2:
								if(iron2%timePassed == 1) {
									generator.addItem();
									ItemStack iron = generator.getItems().get(generator.getItems().size()-1);
									Bukkit.getWorld("world").dropItem(generator.getLocation().add(0.5,1.5,0.5), iron);
								}
